...
const AnaliseBrindesCompleta = () => {
  const top10Clientes = [
    ...
    {
      cliente: 'HH Print',
      totalVendas: 24680.50,
      numeroEncomendas: 7,
      ticketMedio: 3525.79
    },
    {
      cliente: 'Lassarat',
      totalVendas: 19090.00,
      numeroEncomendas: 4,
      ticketMedio: 4772.50
    },
    {
    ...
    {
      cliente: 'Promotorres',
      totalVendas: 11322.40,
      numeroEncomendas: 4,
      ticketMedio: 2830.60
    },
    {
      cliente: 'Tubos Vouga',
      totalVendas: 11023.50,
      numeroEncomendas: 3,
      ticketMedio: 3674.50
    }
  ];
        ...
        <CardContent>
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded">
            ...
            <ul className="list-disc pl-4 space-y-2">
              ...
              <li>Clientes de alto valor e baixo esforço:
              ...
              <li>Clientes que precisam consolidar pedidos:
                <ul className="list-circle pl-4 mt-1">
